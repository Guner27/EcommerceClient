...
export class HttpClientService {
  ...
  private url(requestParameters: Partial<RequestParameters>): string {
    //eğer ki RequestParameters sınıfının içindeki baseUrl doluysa onu kullan o dolu değilse uygulamanın ana baseUrl ini kullan
    //Ardından controller ne ise onu yazdırdık.
    //Ardından eğer Action bildirildi ise /action (adı) ,   yok eğer bildirilmedi ise direk "" boşluk
